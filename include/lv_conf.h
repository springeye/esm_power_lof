...
/* Fonts are declared by LVGL Editor in ui/lof_power_system_gen.h */
#define LV_FONT_CUSTOM_DECLARE  LV_FONT_DECLARE(hos_14_data)

/* Default font: hos_14_data (replaces Montserrat; LV_FONT_MONTSERRAT_* all disabled) */
#define LV_FONT_DEFAULT &hos_14_data
