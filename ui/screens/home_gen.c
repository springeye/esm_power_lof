...
lv_obj_t * home_create(void)
{
    ...
    lv_obj_set_style_pad_row(lv_obj_1, 0, 0);
    ...
    lv_obj_set_style_text_font(lv_label_0, hos_regular, 0);
    lv_label_bind_text(lv_label_0, &system_name, NULL);
    ...
    lv_obj_set_style_text_color(lv_label_2, lv_color_hex(0x0097fa), 0);
    lv_obj_set_style_text_font(lv_label_2, hos_regular, 0);
    
    lv_obj_t * lv_label_3 = lv_label_create(lv_obj_1);
    lv_label_bind_text(lv_label_3, &system_state, NULL);
    lv_obj_set_style_text_color(lv_label_3, lv_color_hex(0x0097fa), 0);
    ...
    lv_obj_set_style_pad_row(lv_obj_2, 0, 0);
    lv_obj_set_style_pad_column(lv_obj_2, 0, 0);
    lv_obj_set_style_pad_left(lv_obj_2, 4, 0);
    lv_obj_set_style_pad_right(lv_obj_2, 4, 0);
    ...
    lv_obj_set_style_pad_row(lv_obj_3, 0, 0);
    lv_obj_set_style_pad_column(lv_obj_3, 0, 0);
    ...
    lv_obj_set_height(lv_obj_4, lv_pct(10));
    ...
    lv_obj_set_style_pad_row(lv_obj_4, 0, 0);
    lv_obj_set_style_pad_column(lv_obj_4, 0, 0);
    lv_obj_add_style(lv_obj_4, &no_padding, 0);
    lv_obj_t * lv_obj_5 = lv_obj_create(lv_obj_4);
    lv_obj_set_width(lv_obj_5, lv_pct(49));
    ...
    lv_obj_set_style_pad_row(lv_obj_5, 0, 0);
    ...
    lv_label_bind_text(lv_label_7, &uptime, NULL);
    lv_obj_set_style_text_color(lv_label_7, lv_color_hex(0xFFFFFF), 0);
    lv_obj_set_style_text_font(lv_label_7, hos_regular, 0);
    ...
    lv_obj_set_style_pad_top(lv_obj_7, 5, 0);
    lv_obj_set_style_margin_top(lv_obj_7, 1, 0);
    lv_obj_add_style(lv_obj_7, &no_padding, 0);
    lv_obj_t * lv_obj_8 = lv_obj_create(lv_obj_7);
    lv_obj_set_width(lv_obj_8, lv_pct(25));
    lv_obj_set_height(lv_obj_8, lv_pct(100));
    lv_obj_set_style_border_color(lv_obj_8, lv_color_hex(0x659595), 0);
    ...
    lv_label_bind_text(lv_label_9, &device_power, NULL);
    lv_obj_set_style_text_color(lv_label_9, lv_color_hex(0xffd208), 0);
    lv_obj_set_style_text_font(lv_label_9, hos_regular, 0);
    
    lv_obj_t * lv_obj_9 = lv_obj_create(lv_obj_7);
    lv_obj_set_width(lv_obj_9, lv_pct(73));
    lv_obj_set_height(lv_obj_9, lv_pct(100));
    lv_obj_set_style_border_color(lv_obj_9, lv_color_hex(0x659595), 0);
    ...
    lv_obj_set_style_pad_row(lv_obj_9, 0, 0);
    lv_obj_set_style_pad_column(lv_obj_9, 0, 0);
    ...
    lv_label_bind_text(lv_label_10, &device_power_percent_txt, NULL);
    ...
    lv_obj_set_style_pad_row(lv_obj_10, 0, 0);
    lv_obj_set_style_pad_column(lv_obj_10, 0, 0);
    lv_obj_set_style_pad_top(lv_obj_10, 5, 0);
    ...
    lv_obj_set_style_radius(lv_obj_11, 5, 0);
    ...
    lv_obj_set_style_pad_row(lv_obj_11, 0, 0);
    lv_obj_set_style_pad_column(lv_obj_11, 0, 0);
    ...
    lv_obj_set_style_pad_column(lv_obj_12, 0, 0);
    ...
    lv_obj_set_style_pad_row(lv_obj_13, 0, 0);
    lv_obj_set_style_pad_column(lv_obj_13, 0, 0);
    lv_obj_set_style_flex_track_place(lv_obj_13, LV_FLEX_ALIGN_CENTER, 0);
    lv_obj_t * lv_label_12 = lv_label_create(lv_obj_13);
    lv_label_bind_text(lv_label_12, &ch1_voltage, NULL);
    ...
    lv_label_bind_text(lv_label_13, &ch1_current, NULL);
    ...
    lv_label_bind_text(lv_label_14, &ch1_pwer, NULL);
    ...
    lv_obj_set_style_border_width(lv_obj_14, 1, 0);
    lv_obj_set_style_radius(lv_obj_14, 5, 0);
    ...
    lv_obj_set_style_pad_row(lv_obj_14, 0, 0);
    lv_obj_set_style_pad_column(lv_obj_14, 0, 0);
    ...
    lv_obj_set_style_pad_column(lv_obj_15, 0, 0);
    ...
    lv_obj_set_style_pad_row(lv_obj_16, 0, 0);
    lv_obj_set_style_pad_column(lv_obj_16, 0, 0);
    lv_obj_set_style_flex_track_place(lv_obj_16, LV_FLEX_ALIGN_CENTER, 0);
    lv_obj_t * lv_label_16 = lv_label_create(lv_obj_16);
    lv_label_bind_text(lv_label_16, &ch2_voltage, NULL);
    ...
    lv_label_bind_text(lv_label_17, &ch2_current, NULL);
    ...
    lv_label_bind_text(lv_label_18, &ch2_pwer, NULL);
    ...
    lv_obj_set_style_border_width(lv_obj_17, 1, 0);
    lv_obj_set_style_radius(lv_obj_17, 5, 0);
    ...
    lv_obj_set_style_pad_row(lv_obj_17, 0, 0);
    lv_obj_set_style_pad_column(lv_obj_17, 0, 0);
    lv_obj_set_style_bg_opa(lv_obj_17, 0, 0);
    lv_obj_set_style_flex_track_place(lv_obj_17, LV_FLEX_ALIGN_CENTER, 0);
    ...
    lv_obj_set_style_pad_all(lv_obj_19, 0, 0);
    lv_obj_set_style_pad_row(lv_obj_19, 0, 0);
    lv_obj_set_style_pad_column(lv_obj_19, 0, 0);
    lv_obj_set_style_flex_track_place(lv_obj_19, LV_FLEX_ALIGN_CENTER, 0);
    lv_obj_t * lv_label_20 = lv_label_create(lv_obj_19);
    lv_label_bind_text(lv_label_20, &ch2_voltage, NULL);
    ...
    lv_label_bind_text(lv_label_21, &ch2_current, NULL);
    ...
    lv_label_bind_text(lv_label_22, &ch2_pwer, NULL);
