...
lv_obj_t * splash_create(void)
{
    ...
    if (!style_inited) {
        ...
        lv_style_set_bg_color(&style_zap_line, lv_color_hex(0xffb020));
    ...
    lv_obj_set_align(bolt, LV_ALIGN_CENTER);
    ...
    lv_obj_set_style_text_font(brand, hos_bold_big, 0);
    lv_obj_set_align(brand, LV_ALIGN_CENTER);
    lv_obj_add_style(brand, &style_brand, 0);
    
    lv_obj_t * zap_line = lv_obj_create(lv_obj_0);
    lv_obj_set_name(zap_line, "zap_line");
    lv_obj_set_width(zap_line, 180);
    lv_obj_set_height(zap_line, 2);
    lv_obj_set_align(zap_line, LV_ALIGN_CENTER);
    ...
    lv_obj_set_align(slogan, LV_ALIGN_CENTER);
